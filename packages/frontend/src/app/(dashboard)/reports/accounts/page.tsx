...
export default function AccountsPage() {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      console.log('Accounts page updating payment:', {
        paymentId: selectedPayment.paymentId,
        oldAmount: Number(selectedPayment.amount),
        oldPaidAmount: Number(selectedPayment.paidAmount),
        newAmount: editFormData.amount,
        newPaidAmount: editFormData.paidAmount,
        vehicleId: selectedPayment.vehicleId,
        carNumber: selectedPayment.vehicle.carNumber
      });
